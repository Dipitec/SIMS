    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                <!--*-_____________________________ PROFILE OF USER_______________________________________-*-->
                ...
                {{--*__________________________ EXAMINATION SECTIONS_______________________________________*--}}
                <li class="nav-item has-treeview">
                    <a href="#" class="nav-link">
